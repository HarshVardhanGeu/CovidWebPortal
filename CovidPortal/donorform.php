...
if (isset($_POST['senddetails'])) {
    ...
    $dayssinceneg = abs(round($diff / 86400));
    ...
    if ($dayssinceneg >= 60)
        ...
        $age = $days / 365;
        //DELETE from donortable datediff(CURRENT_DATE, negativedate)>60;
        $sql = "INSERT into donortable(patientname,bloodgroup,dateofbirth,gender,stateloc,city,Contact,positivedate,negativedate,dayssinceneg,age) VALUES('$patientname','$bg','$dob','$gender','$state','$city','$contact','$posdate','$negdate','$dayssinceneg','$age')";
